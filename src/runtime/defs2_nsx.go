...
GOARCH=386 go tool cgo -cdefs defs2_nsx.go >defs_nsx_386.h

The asm header tricks we have to use for nsx on amd64
...
/*
#cgo CFLAGS: -I/tmp/nsx/arch/x86/include -I/tmp/nsx/include -D_LOOSE_KERNEL_NAMES -D__ARCH_SI_UID_T=__kernel_uid32_t
